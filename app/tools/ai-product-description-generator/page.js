...
function CopyBlock({ label, value, color = '#7c3aed' }) {
          ...
          <div className="tool-form-sticky" style={{
            ...
            <div style={{ marginBottom: '16px' }}>
              <label style={{ display: 'block', color: '#8b8ba0', fontSize: '13px', fontWeight: '500', marginBottom: '8px' }}>
                Product Name <span style={{ color: '#7c3aed' }}>*</span>
              </label>
              <input
                type="text"
            ...
            {result && !loading && (
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {result.title && <CopyBlock label="Product Title" value={result.title} color="#7c3aed" />}
                  {result.short && <CopyBlock label="Short Description" value={result.short} color="#f59e0b" />}
                  {result.full && <CopyBlock label="Full Description" value={result.full} color="#10b981" />}
